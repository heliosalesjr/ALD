    ...
    <div className="container my-24 mx-auto md:px-6">
      ...
      <section className="mb-32 ">
        <div className="flex flex-wrap ">
          ...
          <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-5/12 lg:order-1 z-200">
            <div className="flex lg:py-12 z-200">
              <img
                src="https://mdbcdn.b-cdn.net/img/new/standard/people/033.jpg"
                className="w-full rounded-lg shadow-lg dark:shadow-black/20 lg:ml-[50px] z-200"
                alt="image"
              />
            </div>
          </div>
        ...
        <div className="container my-4 mx-auto md:px-6">
            <h2 className="mb-6 text-xl font-bold">Você pode pesquisar questões como:</h2>
            <ul>
