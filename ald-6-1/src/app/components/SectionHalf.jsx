  ...
  return (
    ...
    whileTap={{ scale: 0.9 }} style={{ backgroundImage: 'url("/images/piggy_real.jpg")' }}></motion.div>
      ...
      <div className="p-8 mb-4 md:w-2/3 mx-auto max-w-screen-lg">
        <h1 className="text-3xl font-bold py-4">O que é Educação Financeira?</h1>
        ...
        <h1 className="text-2xl font-bold mb-4 py-4">Por que Educação Financeira nas escolas?</h1>
        <p className="text-gray-700">
