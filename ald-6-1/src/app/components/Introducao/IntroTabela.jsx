...
export default function IntroTabela() {
  return (
    ...
    <div style={{ maxWidth: "1100px", margin: "0 auto" }} className="py-8">
        ...
        <p className="p-8 mb-4 text-center text-lg text-slate-700">Vamos ver quais Etapas do Projeto, temas de Matemática e ferramentas didáticas serão tratadas neste site:</p>
